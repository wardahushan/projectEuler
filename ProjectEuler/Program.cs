...
namespace Euler
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //while (numberOfDivisors <= 5)
            //{
            //    triangular = EulerHelperFunctions.NthTriangularNumber(n);
            //    numberOfDivisors = EulerHelperFunctions.GetAllFactors(triangular).Count;
            //    n++; 
            //}
            ...
            Console.WriteLine(EulerHelperFunctions.SumIndividualDigitsInString(powerAsString));
